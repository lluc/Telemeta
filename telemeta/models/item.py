...
class MediaItem(MediaResource):
    ...
    informer              = CharField(u"informateur", help_text= u"Nom, prénom; Nom, prénom; ...") #_('informer'), help_text=_('First name, Last name ; First name, Last name'))
    ...
    mshs_composer         = CharField(u"compositeur") #_('composer'))
    mshs_timbre           = CharField(_('timbre'))
    mshs_timbre_ref       = CharField(u"timbre référencé") #_('timbre referenced'))
    mshs_timbre_code      = CharField(u"cote du timbre") # _('timbre code'))
    mshs_alt_title        = CharField(u"autre titre") #_('alternate title'))
    mshs_melody           = TextField(u"mélodie", help_text= u"Vous pouvez utiliser la notation ABC") #(_('melody'), help_text=_('You can use ABC notation'))
    mshs_domain_song      = CharField(u"genre de chanson" ) #_('kind of song'))
    mshs_domain_vocal     = CharField(u"genre vocal") #_('kind of vocal'))
    mshs_domain_music     = CharField(u"genre de musique") #_('kind of music'))
    mshs_domain_tale      = CharField(u"genre de conte") #_('kind of tale'))
    mshs_details          = TextField(u"précisions") #_('Details'))
    mshs_function         = CharField(_('Function'))
    mshs_dance            = CharField(u"danse") #_('Dance'))
    mshs_dance_details    = TextField(u"précisions sur la danse") #_('Details on dance'))
    mshs_deposit_digest   = TextField(u"résumé") #_('Digest'))
    mshs_deposit_thematic = CharField(u"thématique") #_('Thematic'))
    mshs_deposit_names    = CharField(u"noms", help_text= u"Nom, prénom; Nom, prénom; ...")   #_('Names'), help_text=_('First name, Last name ; First name, Last name'))
    mshs_deposit_places   = CharField(u"lieux", help_text=u"Lieu cité; lieu cité; ...")  #_('places'), help_text=_('Place named; place named; ...'))
    mshs_deposit_periods  = CharField(u"périodes", help_text="période relatées; période relatée; ...")  #_('periods'), help_text=_('Period recounted; period recounted; ...'))
    mshs_text_bool        = BooleanField(u"présence de texte ?") #_('Text ?'))
    mshs_text             = TextField(_('Text'))
    mshs_incipit          = CharField(_('incipit'))
    mshs_refrain          = CharField(u"refrain de la chanson") #_('refrain'))
    mshs_jingle           = CharField(u"ritournelle du conte") #_('jingle'))
    mshs_coupe            = WeakForeignKey('Coupe', verbose_name=_('coupe'))
    mshs_title_ref_coirault = CharField(u"titre ref. Coirault") #_('Title ref. Coirault'))
    mshs_code_coirault    = CharField(u"cote Coirault") #_('code Coirault'))
    mshs_title_ref_laforte = CharField(u"titre ref. Laforte") #_('Title ref. Laforte'))
    mshs_code_laforte     = CharField(u"cote Laforte") #_('code Laforte'))
    mshs_title_ref_Dela   = CharField(u"titre ref. Delarue-Teneze") #_('Title ref. Delarue-Teneze'))
    mshs_code_Dela        = CharField(u"cote Delarue-Teneze") #_('code Delarue-Teneze'))
    mshs_title_ref_Aare   = CharField(u"titre ref. Aarne-Thompson") #_('Title ref. Aare-Thomson'))
    mshs_code_Aare        = CharField(u"cote Aarne-Thompson") #_('code Aare-Thomson'))
    mshs_musical_organization = CharField(u"organisation musicale") #_('Musical organization'))
    mshs_group            = CharField(u"formation") #_('Group'))
...
class MediaItemPerformance(ModelCore):
    ...
    musicians       = CharField(u"informateurs") #_('informers'))
